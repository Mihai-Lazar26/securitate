...
if __name__ == '__main__':
    ...
    ciphertext_result_ = encodeText(key2, encodeText(key1, plaintext_))
    print(ciphertext_result_)
    print(decodeText(14, decodeText(4, ciphertext_result_)))
    ...
    print(mitm(plaintext_, ciphertext_result_)) # 32 de chei testate, 16 criptari, 16 decriptari
